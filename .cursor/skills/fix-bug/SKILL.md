...
Stop at human gates (ADR accept). Commit each completed step (spec, then code). If spec was not edited, say `spec unchanged`. Do not mix uncommitted spec and code. Do not merge or push to the default branch.
