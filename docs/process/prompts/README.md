...
- Нумерация соответствует позиции в конвейере и стабильна: переименование файла работы означает правку таблицы маршрутизации в ядре, этого реестра и соответствующего скилла.
