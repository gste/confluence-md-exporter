...
1. **Сломанные относительные пути медиа.**  
   Каталог на диске: `../../../output/03_assets/<page_id>/file`.  
   В таблице трансформации ссылки указаны как `../assets/<page_id>/file`.  
   Из `../../../output/04_markdown/` корректный относительный путь: `../03_assets/<page_id>/file`.  
...
8. Нет **каталога выгрузки** (`../../../output/04_markdown/manifest.json`) — обязателен для последующих AI/RAG пайплайнов.
